        ...
        <section id="projects" className="roadmap">
          ...
          <div className="roadmap-track">
            <ScrollReveal delay={0}>
              <a href="https://foundation1-beta.vercel.app/" className="roadmap-stop" target="_blank" rel="noopener noreferrer">
            ...
            <ScrollReveal delay={100}>
              <a href="https://smellmybuds-chi.vercel.app/" className="roadmap-stop" target="_blank" rel="noopener noreferrer">
                <div className="roadmap-block card-3d">
                  <div className="roadmap-text">
            ...
            <ScrollReveal delay={200}>
              <a href="https://m-ctaxservices.vercel.app/" className="roadmap-stop" target="_blank" rel="noopener noreferrer">
                <div className="roadmap-block card-3d">
                  <div className="roadmap-text">
            ...
            <ScrollReveal delay={300}>
              <a href="https://bearbytes.fyi/" className="roadmap-stop" target="_blank" rel="noopener noreferrer">
                <div className="roadmap-block card-3d">
                  <div className="roadmap-text">
        ...
        <section id="contact" className="contact">
          ...
          <ScrollReveal delay={50}>
            <div className="contact-links">
              <a href="tel:+16502489732" title="Click to call">(650) 248-9732</a>
              <a href="mailto:jjuar090@ucr.edu" title="Click to email">jjuar090@ucr.edu</a>
            </div>
          </ScrollReveal>
        </section>
      </main>
